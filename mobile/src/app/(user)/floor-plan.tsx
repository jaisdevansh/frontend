...
export default function FloorPlan() {
    ...
    const commissionRate = params.commissionRate ? Number(params.commissionRate) : 10; // ✅ CommissionRate fetch karna
    ...
    const handleProceed = () => {
        ...
        router.replace({
            ...
            params: {
                ...
                baseTotal: baseCost,         // ✅ baseTotal bheja
                commissionRate,              // ✅ commissionRate bheja
                ...
                <View style={{ flex: 1 }}>
                    ...
                    <Text style={styles.footPrice}>
                        ₹{(() => {
                            ...
                            return (baseCost + fee).toLocaleString(); // ✅ Base cost mein dynamic fee add karke dikhana
                        })()}
                    </Text>
                </View>
                <TouchableOpacity 
